...
const Home: React.FC = () => {
    ...
    return (
        <Container >
            ...
            <h3>Para aplicar um efeito, click duas vezes no botão do efeito desejado!</h3>
            <Buttons >
                <button onClick={setCinza} style={{backgroundColor: "black"}}> <p> Preto e Branco</p></button>
                <button onClick={setVermelho} style={{backgroundColor: "red"}}> <p> Vermelho</p></button>
                <button onClick={setAzul} style={{backgroundColor: "blue"}}> <p> Azul</p></button>
                <button onClick={setVerde} style={{backgroundColor: "green"}}> <p> Verde</p></button>
                <button onClick={setColorido} style={{background: "linear-gradient(90deg, rgba(255,0,0,1) 0%, rgba(254,255,0,1) 21%, rgba(0,255,85,1) 49%, rgba(0,18,254,1) 69%, rgba(255,0,180,1) 87%, rgba(255,0,0,1) 100%)"}}>Colorido</button>
            </Buttons>
